...
import sys 
sys.path.append("/home/zyw/data/repo_common/Implicit3DUnderstanding/")

from models.datasets import PIX3DLDIF, FRONT3D_LDIF
import collections
...
class LDIF_Dataset(FRONT3D_LDIF):
...
if __name__ == '__main__':
    with open('./configs/ldif_front3d.yaml') as f:
        config = yaml.load(f, Loader=yaml.FullLoader)
    dataset = LDIF_Dataset(config, 'test')
    dataloader = LDIF_dataloader(config, 'test')
